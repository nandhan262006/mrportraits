...
const reasons = [
  {
    ...
    description:
      "Fun, classy, and natural — our images balance dramatic golden hour lighting with raw emotional storytelling.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Weddings, engagements, maternity, baby, birthdays and events — the same quality standard for every occasion you love.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
